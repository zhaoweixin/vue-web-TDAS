<template lang="html">
  ...
  <div id="parentx">
    ...
    <vs-button @click="active=!active, notExpand = true" color="success" vs-type="filled" vs-icon="more_horiz"></vs-button>
    <vs-sidebar position-right :reduce="reduce" :reduce-not-hover-expand="notExpand" parent="body" default-index="1"  color="success" class="sidebarx" spacer v-model="active">
